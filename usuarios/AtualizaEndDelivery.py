...
status = ['A', 'I', 'F', 'C']
localizacoes = [
    "Rua Deputado Salles Filho, 469 - Adamantina/SP - 17800-959",
    "Av. Rio Branco, 250 - Adamantina/SP - 17800-970",
    "Rua Joaquim Nabuco, 120 - Adamantina/SP - 17806-200",
    "Av. Santos Dumont, 800 - Adamantina/SP - 17805-220",
    "Rua Antonio Tiveron, 792 - Adamantina/SP - 17800-000",
    "Rua Valentim Gatti, 55 - Adamantina/SP - 17805-236",
    "Rua Luiz Stechi, 40 - Adamantina/SP - 17806-210",
    "Rua Emílio Casas Fidalgo, 300 - Adamantina/SP - 17807-808",
    "Rua das Palmeiras, 100 - Adamantina/SP - 17800-390",
    "Rua Portugal, 75 - Adamantina/SP - 17808-590",
    "Rua Osvaldo Cruz, 150 - Adamantina/SP - 17800-970",
    "Av. Marechal Deodoro, 200 - Adamantina/SP - 17806-220",
    "Rua Sete de Setembro, 310 - Adamantina/SP - 17800-960",
    "Rua São Paulo, 420 - Adamantina/SP - 17805-230",
    "Rua Paraná, 510 - Adamantina/SP - 17806-240",
    "Rua Minas Gerais, 600 - Adamantina/SP - 17806-250",
    "Rua Goiás, 700 - Adamantina/SP - 17806-260",
    "Rua Ceará, 800 - Adamantina/SP - 17806-270",
    "Rua Bahia, 900 - Adamantina/SP - 17806-280",
    "Rua Amazonas, 1000 - Adamantina/SP - 17806-290"
]
...
for i in range(100):
    ...
    fechamento = 'Indefinido' if stat in ['A','I','C'] else abertura + timedelta(hours=1, minutes=15)
