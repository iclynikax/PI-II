...
class Perfil(models.Model):
    ...
    id_mn_Esquerdo = models.CharField(
        max_length=1, choices=Menu_Esquerdo, default='1')
...
class Prfl_Endereco(models.Model):
    # models.ForeignKey, pode haver múltiplos perfis por usuário
    # — o que quebra a lógica do get_or_create().
